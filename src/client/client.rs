...
use futures::{FutureExt, SinkExt, StreamExt, TryFutureExt, stream::SplitSink};
use tokio::{
...
use crate::{codec::{Addr, codec::{Command, RepCode}}, error::{CustomError, SocksResult}, util::copy::{client_read_from_tcp_to_websocket, client_read_from_websocket_to_tcp}};
